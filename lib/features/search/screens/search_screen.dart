                          ...
                          child: CustomTextFieldWidget(
                            ...
                            onSuffixTap: () {
                              if (_searchController.text.isNotEmpty) {
                                ...
                                Navigator.pushNamed(context, Routes.getSearchResultRoute(text: _searchController.text));
                              }
                            },
              ...
              Expanded(child: Padding(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) => InkWell(
                    onTap: () {
                      Navigator.pushNamed(context, Routes.getSearchResultRoute(text: searchProvider.historyList[index]));
                    },
                    child: Padding(

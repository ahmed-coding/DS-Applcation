...
import 'package:digitstitch_user/features/auth/widgets/sign_up_logo_widget.dart';
...
import 'package:digitstitch_user/features/auth/widgets/code_picker_widget.dart';
                                    ...
                                    registrationProvider.registration(signUpModel, config).then((status) async {
                                      if (status.isSuccess) {
                                        ...
                                        Navigator.of(context).pushNamed(
                                          Routes.getVerifyRoute('sign-up', '${config.phoneVerification! ?  signUpModel.phone : signUpModel.email}'),
                                        );
                                      }
                                    });
                                  }

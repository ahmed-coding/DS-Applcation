...
class _TrackingMapWidgetState extends State<TrackingMapWidget> {
  ...
  void initState() {
   ...
   OrderMapProvider orderMapProvider =  Provider.of<OrderMapProvider>(context, listen: false);
    ...
    orderMapProvider.addressLatLng = widget.addressModel != null ? LatLng(double.parse(widget.addressModel!.latitude!), double.parse(widget.addressModel!.longitude!)) : const LatLng(0,0);

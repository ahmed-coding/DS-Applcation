...
class CustomStepperWidget extends StatelessWidget {
  ...
  final Widget? child;
  final double height;
  const CustomStepperWidget({Key? key, required this.title, required this.isActive, this.child, this.haveTopBar = true, this.height = 30}) : super(key: key);
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      haveTopBar ? Row(children: [
        Container(
          ...
          color: isActive ? Theme.of(context).primaryColor : ColorResources.colorGrey,
        ),
      ...
      Row(children: [
        isActive ? Icon(Icons.check_circle, color: Theme.of(context).primaryColor, size: 30) : Container(
          ...
          decoration: BoxDecoration(border: Border.all(color: ColorResources.colorGrey, width: 2), shape: BoxShape.circle),
        ),

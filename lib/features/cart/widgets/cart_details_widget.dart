...
import 'package:digitstitch_user/features/cart/widgets/cart_coupon_widget.dart';
import 'package:digitstitch_user/features/cart/widgets/select_delivery_type_widget.dart';
...
class CartDetailsWidget extends StatelessWidget {
  ...
  const CartDetailsWidget({Key? key,
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              CartCouponWidget(couponTextController: couponController, totalAmount: total),

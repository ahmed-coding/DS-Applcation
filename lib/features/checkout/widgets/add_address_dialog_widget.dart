          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            TextButton.icon(
              onPressed: () async {
                ...
                await Navigator.pushNamed(context, Routes.getAddAddressRoute('checkout', 'add', AddressModel()));
...
class CurrentLocationButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextButton.icon(
      onPressed: (){
        Navigator.pop(context);
        Navigator.pushNamed(context, Routes.getAddAddressRoute('checkout', 'add', AddressModel()));
      },

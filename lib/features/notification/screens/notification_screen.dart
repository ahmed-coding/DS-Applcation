...
import 'package:digitstitch_user/features/notification/widgets/notification_dialog_widget.dart';
...
class NotificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isLogIn = Provider.of<AuthProvider>(context, listen: false).isLoggedIn();
    ...
    return Scaffold(
      ...
      body: !isLogIn ? const NotLoggedInScreen() : Consumer<NotificationProvider>(

...
import 'package:digitstitch_user/features/product/widgets/product_review_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<ProductProvider>(builder: (context, productProvider, _){
      return productProvider.product == null ? const SizedBox() : productProvider.tabIndex == 0 ? (productProvider.product!.description == null || productProvider.product!.description!.isEmpty)
        ...
        if(productProvider.product?.description != null) Container(
        ...
        if(productProvider.product!.description!.length > 300 && showSeeMoreButton) Positioned.fill(child: Align(

...
import 'package:digitstitch_user/features/category/widgets/category_item_widget.dart';
import 'package:digitstitch_user/features/category/widgets/sub_categories_shimmer_widget.dart';
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      onTap: () {
                        ...
                        if(index == 0) {
                          Navigator.pushNamed(context, Routes.getCategoryRoute(

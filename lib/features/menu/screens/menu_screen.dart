...
import 'package:digitstitch_user/common/widgets/theme_switch_button_widget.dart';
...
import 'package:digitstitch_user/features/menu/widgets/menu_web_widget.dart';
import 'package:digitstitch_user/features/menu/widgets/portion_widget.dart';
                  ...
                  child: Column(children: [
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          PortionWidget(imageIcon: Images.profileMenuIcon, title: getTranslated('profile', context), route: Routes.getProfileRoute()),
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Container(
                        ...
                        margin: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                        child: Column(children: [
                          PortionWidget(imageIcon: Images.message, title: getTranslated('live_chat', context), route: Routes.getChatRoute()),
                          PortionWidget(imageIcon: Images.helpSupport, title: getTranslated('help_and_support', context), route: Routes.getSupportRoute()),
                          PortionWidget(imageIcon: Images.aboutUs, title: getTranslated('about_us', context), route: Routes.getAboutUsRoute()),
                          PortionWidget(imageIcon: Images.termsAndCondition, title: getTranslated('terms_and_condition', context), route: Routes.getTermsRoute()),
                          PortionWidget(imageIcon: Images.privacyPolicy, title: getTranslated('privacy_policy', context), route: Routes.getPolicyRoute()),

                          if(policyModel?.refundPage?.status ?? false)
                            PortionWidget(imageIcon: Images.refundPolicy, title: getTranslated('refund_policy', context), route: Routes.getRefundPolicyRoute()),

                          if(policyModel?.returnPage?.status ?? false)
                            PortionWidget(imageIcon: Images.refundPolicy, title: getTranslated('return_policy', context), route: Routes.getReturnPolicyRoute()),

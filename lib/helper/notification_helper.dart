...
import 'package:digitstitch_user/features/notification/domain/models/payload_model.dart';
...
import 'package:digitstitch_user/features/notification/widgets/notifiation_popup_dialog_widget.dart';
  ...
  static Future<void> initialize(FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin) async {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      if(message.data['type'] == 'message') {
        ...
        Provider.of<ChatProvider>(Get.context!, listen: false).getMessages(1, id , false);
      }else{
        int? orderId = int.tryParse('${message.data['order_id']}');
        if(orderId != null) {
          Provider.of<OrderProvider>(Get.context!, listen: false).getTrackOrder('$orderId', null, false);

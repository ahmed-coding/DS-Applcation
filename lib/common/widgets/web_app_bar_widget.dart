...
import 'package:digitstitch_user/common/enums/popup_menu_type_enum.dart';
import 'package:digitstitch_user/common/widgets/cart_count_widget.dart';
...
import 'package:digitstitch_user/common/widgets/on_hover.dart';
import 'package:digitstitch_user/common/widgets/profile_hover_widget.dart';
              ...
              child: Center(child: SizedBox(width: Dimensions.webScreenWidth, child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(height: Dimensions.paddingSizeLarge, child: MouseRegion(
                      onHover: (details)=> _showPopupMenu(details.position, context, PopupMenuType.language),
                      child: Row(children: [
                        Text('${currentLanguage.languageCode?.toUpperCase()}', style: rubikMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                  ...
                  Row(children: [
                    TextHoverWidget(builder: (isHover)=> Container(
                      ...
                      child: Consumer<SearchProvider>(builder: (context, search,_)=> Container(
                        decoration: BoxDecoration(
                            border: Border.all(color: Theme.of(context).primaryColor.withOpacity(0.07), width: 1),
                            borderRadius: BorderRadius.circular(Dimensions.paddingSizeLarge)
                        ),
                        child: CustomTextFieldWidget(
                          ...
                          suffixIconUrl: search.isSearch ? Images.search : Images.close,
                          onChanged: (str){
                            str.length = 0;
                          ...
                          onSuffixTap: () {
                            if(search.searchController.text.isNotEmpty && search.isSearch == true){
                              ...
                              Navigator.pushNamed(context, Routes.getSearchResultRoute(text: search.searchController.text));
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          ...
                          Text(getTranslated('coupon', context), style: rubikMedium.copyWith(
                            ...
                            color: themeProvider.darkTheme ? Theme.of(context).primaryColor : Theme.of(context).textTheme.titleMedium?.color,
                          )),
                          const SizedBox(width: Dimensions.paddingSizeExtraSmall),

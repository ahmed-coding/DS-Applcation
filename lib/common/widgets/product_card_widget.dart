...
class ProductCardWidget extends StatelessWidget {
  ...
  const ProductCardWidget({Key? key, required this.product, this.direction = Axis.vertical}) : super(key: key);
    ...
    return Consumer<CartProvider>(
      builder: (context, cartProvider, _) {
        ...
        return OnHover(isItem: true, child: InkWell(
          ...
          onTap: ()=> Navigator.of(context).pushNamed(Routes.getProductDetailsRoute(product.id)),
          child: Container(
